...
api.add_resource(apis.QuestionApi, '/<tenant_id>/api/questions/<int:question_id>')
api.add_resource(apis.ResponseApi, '/<tenant_id>/api/questions/<int:question_id>/response')
