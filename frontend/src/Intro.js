...
export default class Intro extends React.Component {
  render = () => (<div className="font-monospace">
    ...
    <p>Santa has hired us, a <i>Rag Tag</i> group of robot mercenaries known as the "Bad Baker's Dozen".</p>
    <p>We are here and ready to kick some Martian butt.</p>
    <p>Your mission, should you choose to accept it, is to join the ranks of the "Bad Baker's Dozen", help defeat the Martian Invaders and Save Christmas!</p>
